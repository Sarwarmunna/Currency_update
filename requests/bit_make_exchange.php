...
if($query->num_rows>0) {	
		...
		if($check->num_rows>0) {
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<!--<form id="bit_confirm_transaction"  method="POST" enctype="multipart/form-data">-->
					<table class="table table-striped">
						<tr>
							<td colspan="2"><h4><?php echo $lang['data_about_transfer']; ?></h4></td>
						</tr>
    ...
    <div class="form-group">
        <label for="file" style="color:#fff;font-size:20px">Upload ScreenShot</label>
        <input type="file" class="form-control" id="file" name="file" required />
    </div>
    <div class="form-group">
							<label style="color:#fff;font-size:20px"><?php echo $lang['enter_transaction_number']; ?></label>
							<input type="text" class="form-control" name="transaction_id">
						</div>
	<input type="hidden" name="updatePostID" value="<?php echo $row['id']; ?>">
...
<script type="text/javascript">
    ...
    $("#fupForm").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: 'https://sarwar35.com/currency_management/requests/submit.php',
            ...
            success: function(response){ console.log(response);
                ...
                window.location.href="https://sarwar35.com/currency_management/sources/submit_done.php";
                $('#fupForm').css("opacity","");
            ...
            // window.href= "https://sarwar35.com/currency_management/requests/submit_done.php";
        });
    });
});
</script>