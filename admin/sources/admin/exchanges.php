					...
					<form action="" method="POST">
						<div class="form-group">
							...
							<select class="form-control" name="status" onchange="show_field(this.value);">
								...
								<option value="3" <?php if($row['status'] == "3") { echo 'selected'; } ?>>Pending</option>
				...
				if($query->num_rows>0) {
					while($row = $query->fetch_assoc()) {
						...
						<tr>
						 ...
						 <td>
                                  <img src="https://sarwar35.com/currency_management/requests/uploads/<?php echo $row['image']; ?>" style="width:235px;height:135px;" class="img-table"></td>
