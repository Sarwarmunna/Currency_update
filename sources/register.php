		...
		<div class="container">
			<div class="row text-center">
				...
				<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
					<div class="user-account">
						...
						if(isset($_POST['bit_login'])) {
							...
							if(empty($username) or empty($email) or empty($password) or empty($repassword)) {
								...
								if($verify_type == "9") {
									$update = $db->query("UPDATE bit_users SET status='3',mobile_number='$mobile_number' WHERE id='$row[id]'");
								}
					...
					<input type="text" class="form-control" name="mobile_number" placeholder="Mobile_number">
				</div>
							<div class="form-group">
